    ...
    fn new() -> Result<Self, anyhow::Error> {
        let pipeline = gst::parse_launch(
            &"webrtcbin name=webrtcbin stun-server=stun://stun.l.google.com:19302 \
             ...
             avdec_h264 ! queue ! videoconvert ! videoscale ! video/x-raw,width=1280,height=720 ! x264enc tune=zerolatency ! rtph264pay ! capsfilter caps=\"application/x-rtp,pt=96,media=video\" ! queue name=vqueue"
                .to_string(),
        )?;
